          ...
          <div className="flex justify-center">
            ...
            >
              <div className="text-left">
                <h3 className="font-display font-semibold text-3xl sm:text-4xl lg:text-5xl text-gray-900 mb-6 tracking-tight leading-tight">
                ...
                <div className="text-gray-600 leading-relaxed mb-8 text-lg font-light">
